  ...
  */
            ...
            if (Settings.templateCache && cachedTemplate) {
              ...
              */
              var firstChar = filename && filename.charAt(0)
                , homeDir   = res.home || Settings.home
                , rootDir   = res.root || Settings.root
                , fullpath  = path.join(firstChar == '/' ? rootDir : homeDir, filename)
                ;
  ...
  var fileHandler = function(req, res) {
    ...
    var homeDir   = res.home || Settings.home
      , fullPath  = path.join(homeDir, url)
      ;
  ...
  var requestHandler = function(req, res) {
    ...
    res.sendRootFile = function(filePath) {
      var rootDir = res.root || Settings.root;
      writeFile(res, path.join(rootDir, filePath));
    };
